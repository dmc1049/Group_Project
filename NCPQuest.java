...
public class NCPQuest {
	...
	public static void NCPBlacksmith(){
		...
		if (rand_int1 <= 5) {
			System.out.print("You will need to travel to the caves that are on the outskirts of town." + NEWLINE + "There you will find a cave with the letter S above its opening." + NEWLINE + "Look for a piece of metal about 1 foot long and 6 inches wide. It will be in a chest near the back of the cave." + NEWLINE + "Be careful there is a troll guarding the chest." );
