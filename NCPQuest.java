...
public class NCPQuest {
	...
	public static void NCPBlacksmith(){
		...
		if (rand_int1 <= 5) {
			 System.out.print("\n\tAdventurer, fight your way to the caves that are on the outskirts of town." + GameEngine.NEWLINE + 
	            ...
	            System.out.println(GameEngine.NEWLINE + "\t Do Adventurer accept the Quest? Y for Yes; N for No: ");
	...
	public static void NCPWizard() {
		...
		if (rand_int1 <= 5) {
			...
			System.out.println(GameEngine.NEWLINE + "\tDo you accept the Quest? Y for Yes; N for No: ");
			scanResult = NCPscan.next();
			scanResult = scanResult.toUpperCase();
			if (scanResult.contentEquals("Y")) {
				WStoneOfTruth();
		...
		if(rand_int1 >=6) {
			System.out.println("\tYou will need to travel to the Abscale Mountains that is to the South-West of town." + GameEngine.NEWLINE + 
	...
	public static void NCPWitch() {
		...
		if(rand_int1 >=6) {
			System.out.println("\tYou will need to travel to the Grassy Swamp that is to the South-West of town." + GameEngine.NEWLINE + 
